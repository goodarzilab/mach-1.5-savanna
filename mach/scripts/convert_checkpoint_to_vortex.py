...
def parse_args():
    parser = argparse.ArgumentParser(description='Convert checkpoint to Vortex format')
    ...
    parser.add_argument('--new_checkpoint_path', type=str, required=True,
                      help='Path where the converted checkpoint will be saved')
...
def main():
    ...
    new_checkpoint_path = args.new_checkpoint_path
