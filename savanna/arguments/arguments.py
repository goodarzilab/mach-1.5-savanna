...
class GlobalConfig(*BASE_CLASSES):
    ...
    def calculate_derived(self):
        ...
        # Debug prints
        print("\n=== Batch Parameters Debug ===")
        print(f"dp_world_size: {dp_world_size}")
        print(f"Input train_batch: {self.train_batch_size}")
        print(f"Input micro_batch: {self.train_micro_batch_size_per_gpu}")
        print(f"Input grad_acc: {self.gradient_accumulation_steps}")
        print(f"Calculated train_batch_size: {train_batch_size}")
        print(f"Calculated train_micro_batch_size_per_gpu: {train_micro_batch_size_per_gpu}")
        print(f"Calculated gradient_accumulation_steps: {gradient_accumulation_steps}")
        print(f"global_num_gpus: {global_num_gpus}")
        print(f"model_parallel_size: {self.model_parallel_size}")
        print(f"pipe_parallel_size: {self.pipe_parallel_size}")
        print(f"context_parallel_size: {self.context_parallel_size}")
        print("===========================\n")
